  ...
  /**
    ...
    */
    interfaceAppend: function () {
      ...
      var body = $('body');
      $('head').append('<link rel="stylesheet" type="text/css" media="all" href="http://cssonsails.org/xprecise/xprecise.min.css" />');

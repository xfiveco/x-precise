  ...
  /**
    ...
    */
    interfaceAppend: function () {
      ...
      var body = $('body');
      $('head').append('<link rel="stylesheet" type="text/css" media="all" href="http://xfiveco.github.io/x-precise/xprecise.min.css" />');
